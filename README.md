...
6. If you did everything correct, https://hiration.github.io/integration-documentation/ will lead to your new docs
...
- Documentation(ReDoc): https://hiration.github.io/integration-documentation/
- SwaggerUI: https://hiration.github.io/integration-documentation/swagger-ui/
- Look full spec:
    + JSON https://hiration.github.io/integration-documentation/swagger.json
    + YAML https://hiration.github.io/integration-documentation/swagger.yaml
- Preview spec version for branch `[branch]`: https://hiration.github.io/integration-documentation/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://hiration.github.io/integration-documentation/ with url from the message: `Server started <url>`
